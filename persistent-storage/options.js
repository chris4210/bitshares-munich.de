...
module.exports= {
    ...
    price_list_metadata: [
        ...
        {key: 'bts/eur', img_src:'img/bitBTS.png', width:15, height:15, alt:"BTS_BTC/EUR", border:0,  label: 'BTS/EUR'},

        {key: 'bitusd/eur', img_src:'img/bitUSD.png', width:15, height:15, alt:"bitUSD", border:0,  label: 'bitUSD/EUR'},

        {key: 'bitSILVER_BTC', img_src:'img/bitSILV.png', width:15, height:15, alt:"bitSILV", border:0, label: 'bitSILV/EUR'},

        {key: 'bitGOLD_BTC', img_src:'img/bitGOLD.png', width:15, height:15, alt:"bitGOLD", border:0, label: 'bitGOLD/EUR'},

        {key: 'bitCNY_BTC', img_src:'img/bitCNY.png', width:15, height:15, alt:"bitCNY", border:0, label: 'bitCNY/EUR'},

        {key: 'biteur/eur', img_src:'img/bitEUR.png', width:15, height:15, alt:"bitEUR", border:0, label: 'bitEUR/EUR'} ,
