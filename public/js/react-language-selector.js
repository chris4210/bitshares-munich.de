React.LS = (function () {
	...
	Lang.prototype.UI = React.createClass({
		...
		render: function () {
			...
			var getPopup = function () {
				...
				if (openMode === 'hover') {
					return React.createElement("ul", {
							className: "rlsui-language-container-scrollable dropdown-menu pull-right",
			...
			else{return React.createElement("li", {className: "react-language-selector-ui dropdown"}, getSelectedLanguage(), " ", getPopup());}
